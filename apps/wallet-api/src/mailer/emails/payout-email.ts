import { TransactionReceipt } from './transaction-email';
      ...
      <html>
        <body style="font-family: Arial, sans-serif; color: #333; line-height: 1.6; margin: 0; padding: 0;">
          <div style="max-width: 600px; margin: 20px auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
            <h1 style="text-align: left;">Payout Receipt</h1>
            <p>Dear ${data.customerName},</p>
            <p>Thank you for trusting XafPay! Below are the details of your transaction:</p>
            <p style="margin-top: 20px; font-size: 16px;">
              ...
              <strong>Amount Received:</strong> ${data.amountReceived}<br>
              <strong>Initiated At:</strong> ${data.initiatedAt}<br>
              <strong>Payout At:</strong> ${data.payoutAt}<br>
            </p>
